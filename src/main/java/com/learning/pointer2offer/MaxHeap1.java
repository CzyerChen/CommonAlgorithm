...
public class MaxHeap1<T> {
    ...
    public MaxHeap1(List<T> heap, Comparator<T> comparator) {
        super();
        this.heap = heap;
    ...
    public static void main(String args[]) {
        ...
        List<Integer> array = new ArrayList<Integer>(Arrays.asList(4));//null, 1, 2,5, 10, 3, 7, 11, 15, 17, 20, 9, 15, 8, 16
        MaxHeap1<Integer> mh = new MaxHeap1<Integer>(array);
        mh.adjust();
        ...
        System.out.println("调整后的初始堆:" + array);
        while(mh.heap.size() > 4){
            mh.delete(0);
            System.out.println("调整后的堆:" + array);
        }
